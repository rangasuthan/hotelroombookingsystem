...
# Add a method to create a table
def create_table():
    create_table_query = """
...
# Add a method to update guest details
def update_guest_details(guest_name, checkin_date, checkout_date):
    insert_data_query = """
    INSERT INTO guests (guest_name, checkin_date, checkout_date)
    VALUES (%s, %s, %s)
    """
    data = (guest_name, checkin_date, checkout_date)
